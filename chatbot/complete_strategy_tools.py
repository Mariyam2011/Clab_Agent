...
@tool(
    "generate_complete_application_strategy",
    args_schema=CompleteStrategyInput,
    return_direct=True,
)
def generate_complete_application_strategy(
    ...
    # Ensure list format
    narrative_list = (
        narratives.get("narrative_angles", narratives)
...
def route_tool_call_complete(
    user_request: str, user_profile: Union[Dict[str, Any], str]
) -> Any:
    """
